...
public class Adacting_demo {
	...
	@AfterMethod
	private static void nextpage_confirmbook() throws InterruptedException {
     ...
     @AfterClass
     private static void hh() throws InterruptedException {
